      ...
      <div class="c-profile">
        ...
        <div class="c-profile__hero">
          <div class="hero__image">
            ...
            /> -->
            <img
              src="../assets/img/about/Alexander_Stojanovich_full.png"
              alt=""
              data-scroll-speed="1"
            />
          </div>
          <div class="hero-content">
            <h1 class="hero-content__title span-overflow">
              <span class="ov-inner">
                A<span class="fraunces">l</span>exander
                <span class="fraunces">S.</span>
              </span>
            </h1>
            <div class="hero-content__caption">
              <p>Alexander Stojanović.</p>
              <p>Sep 23, 2022</p>
              <p>by @jag_ubani</p>
            </div>
          </div>
        ...
        <div class="c-profile__intro">
          <div class="intro__image">
            <img
              src="../assets/img/about/Aleksandar_Stojanovic_Product_Designer-old.png"
              alt=""
            />
            <p class="c-caption">
              Alexander S. &nbsp; <span>December 19, 2020</span>
            </p>
          </div>
          <div class="intro__text">
            <div class="inner">
              <h2>is a Serbian based product designer</h2>
              <p class="para-1">
                — who specializes in digital products and consultation while
                keeping a minimalist approach with clarity and balance in mind.
                I define & design all things digital. With solid expertise in a
                wide range of design disciplines, from UX to product to brand, I
                believe any idea can be brought to life — no matter the
                complexity.
              </p>
              <p>
